...
/** Here the user cart will be stored */
...
export type PersonManyWhereInput = {
  ...
  orders?: InputMaybe<Array<Scalars['String']>>;
  /** Matches if the field array contains *all* items provided to the filter */
  orders_contains_all?: InputMaybe<Array<Scalars['String']>>;
  /** Matches if the field array does not contain any of the items provided to the filter */
  orders_contains_none?: InputMaybe<Array<Scalars['String']>>;
  /** Matches if the field array contains at least one item provided to the filter */
  orders_contains_some?: InputMaybe<Array<Scalars['String']>>;
  /** Matches if the field array does not contains *all* items provided to the filter or order does not match */
...
export type ScheduledOperationAffectedDocument = Asset | Cart | Category | Collection | Currency | Order | OrderItem | Person | Product | ProductColorVariant | ProductSizeColorVariant | ProductSizeVariant | Review;
...
export type CreatePersonMutation = { __typename?: 'Mutation', createPerson?: { __typename?: 'Person', id: string } | null };
...
export type DeleteOrderByIdMutation = { __typename?: 'Mutation', deleteOrder?: { __typename?: 'Order', id: string } | null };

export type DeleteOrderItemByIdMutationVariables = Exact<{
  id: Scalars['ID'];
}>;
...
export type ProductDetailsFragment = { __typename?: 'Product', name: string, slug: string, price: number, description: string, images: Array<{ __typename?: 'Asset', url: string, width?: number | null, height?: number | null }> };
...
export type GetManyProductsBySlugsQueryVariables = Exact<{
  slug_in: Array<Scalars['String']> | Scalars['String'];
}>;


export type GetManyProductsBySlugsQuery = { __typename?: 'Query', products: Array<{ __typename?: 'Product', name: string, slug: string, price: number, description: string, images: Array<{ __typename?: 'Asset', url: string, width?: number | null, height?: number | null }> }> };

export type GetOrderDetailsByIdQueryVariables = Exact<{
  id: Scalars['ID'];
}>;
...
export type GetPersonDetailsByEmailQuery = { __typename?: 'Query', person?: { __typename?: 'Person', address: Array<string>, orders: Array<string>, avatar?: { __typename?: 'Asset', url: string, width?: number | null, height?: number | null } | null } | null };

export type GetPersonOrdersByEmailQueryVariables = Exact<{
  email: Scalars['String'];
}>;
...
export type GetProductBySlugQuery = { __typename?: 'Query', product?: { __typename?: 'Product', name: string, slug: string, price: number, description: string, images: Array<{ __typename?: 'Asset', url: string, width?: number | null, height?: number | null }> } | null };

export type GetProductListQueryVariables = Exact<{ [key: string]: never; }>;


export type GetProductListQuery = { __typename?: 'Query', products: Array<{ __typename?: 'Product', name: string, slug: string, price: number, description: string, images: Array<{ __typename?: 'Asset', url: string, width?: number | null, height?: number | null }> }> };
...
export type GetProductListByPageQuery = { __typename?: 'Query', products: Array<{ __typename?: 'Product', name: string, slug: string, price: number, description: string, images: Array<{ __typename?: 'Asset', url: string, width?: number | null, height?: number | null }> }> };
...
export type UpdateOrderMutation = { __typename?: 'Mutation', updateOrder?: { __typename?: 'Order', id: string, total: number } | null };

export type UpdatePersonOrdersByEmailMutationVariables = Exact<{
  email: Scalars['String'];
  orders?: InputMaybe<Array<Scalars['String']> | Scalars['String']>;
}>;


export type UpdatePersonOrdersByEmailMutation = { __typename?: 'Mutation', updatePerson?: { __typename?: 'Person', id: string } | null };
...
export type UpsertOrderMutation = { __typename?: 'Mutation', upsertOrder?: { __typename?: 'Order', id: string, total: number, orderItems: Array<{ __typename?: 'OrderItem', id: string, quantity: number, product?: { __typename?: 'Product', slug: string } | null }> } | null };

export const OrderItemDetailsFragmentDoc = gql`
...
export const DeleteOrderByIdDocument = gql`
  ...
  deleteOrder(where: {id: $id}) {
    ...
    `;
export type DeleteOrderByIdMutationFn = Apollo.MutationFunction<DeleteOrderByIdMutation, DeleteOrderByIdMutationVariables>;

/**
 * __useDeleteOrderByIdMutation__
 *
 * To run a mutation, you first call `useDeleteOrderByIdMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useDeleteOrderByIdMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [deleteOrderByIdMutation, { data, loading, error }] = useDeleteOrderByIdMutation({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useDeleteOrderByIdMutation(baseOptions?: Apollo.MutationHookOptions<DeleteOrderByIdMutation, DeleteOrderByIdMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<DeleteOrderByIdMutation, DeleteOrderByIdMutationVariables>(DeleteOrderByIdDocument, options);
      }
export type DeleteOrderByIdMutationHookResult = ReturnType<typeof useDeleteOrderByIdMutation>;
export type DeleteOrderByIdMutationResult = Apollo.MutationResult<DeleteOrderByIdMutation>;
export type DeleteOrderByIdMutationOptions = Apollo.BaseMutationOptions<DeleteOrderByIdMutation, DeleteOrderByIdMutationVariables>;
export const DeleteOrderItemByIdDocument = gql`
  ...
  deleteOrderItem(where: {id: $id}) {
    ...
    `;
export type DeleteOrderItemByIdMutationFn = Apollo.MutationFunction<DeleteOrderItemByIdMutation, DeleteOrderItemByIdMutationVariables>;

/**
 * __useDeleteOrderItemByIdMutation__
 *
 * To run a mutation, you first call `useDeleteOrderItemByIdMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useDeleteOrderItemByIdMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [deleteOrderItemByIdMutation, { data, loading, error }] = useDeleteOrderItemByIdMutation({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useDeleteOrderItemByIdMutation(baseOptions?: Apollo.MutationHookOptions<DeleteOrderItemByIdMutation, DeleteOrderItemByIdMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<DeleteOrderItemByIdMutation, DeleteOrderItemByIdMutationVariables>(DeleteOrderItemByIdDocument, options);
      }
...
/**
 * __useGetManyProductsBySlugsQuery__
 *
 * To run a query within a React component, call `useGetManyProductsBySlugsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetManyProductsBySlugsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetManyProductsBySlugsQuery({
 *   variables: {
 *      slug_in: // value for 'slug_in'
 *   },
 * });
 */
export function useGetManyProductsBySlugsQuery(baseOptions: Apollo.QueryHookOptions<GetManyProductsBySlugsQuery, GetManyProductsBySlugsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetManyProductsBySlugsQuery, GetManyProductsBySlugsQueryVariables>(GetManyProductsBySlugsDocument, options);
      }
export function useGetManyProductsBySlugsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetManyProductsBySlugsQuery, GetManyProductsBySlugsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetManyProductsBySlugsQuery, GetManyProductsBySlugsQueryVariables>(GetManyProductsBySlugsDocument, options);
        }
...
export const GetOrderDetailsByIdDocument = gql`
...
/**
 * __useGetOrderDetailsByIdQuery__
 *
 * To run a query within a React component, call `useGetOrderDetailsByIdQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetOrderDetailsByIdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetOrderDetailsByIdQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useGetOrderDetailsByIdQuery(baseOptions: Apollo.QueryHookOptions<GetOrderDetailsByIdQuery, GetOrderDetailsByIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetOrderDetailsByIdQuery, GetOrderDetailsByIdQueryVariables>(GetOrderDetailsByIdDocument, options);
      }
export function useGetOrderDetailsByIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetOrderDetailsByIdQuery, GetOrderDetailsByIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetOrderDetailsByIdQuery, GetOrderDetailsByIdQueryVariables>(GetOrderDetailsByIdDocument, options);
        }
export type GetOrderDetailsByIdQueryHookResult = ReturnType<typeof useGetOrderDetailsByIdQuery>;
export type GetOrderDetailsByIdLazyQueryHookResult = ReturnType<typeof useGetOrderDetailsByIdLazyQuery>;
export type GetOrderDetailsByIdQueryResult = Apollo.QueryResult<GetOrderDetailsByIdQuery, GetOrderDetailsByIdQueryVariables>;
...
/**
 * __useGetPersonCredentialsByEmailQuery__
 *
 * To run a query within a React component, call `useGetPersonCredentialsByEmailQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetPersonCredentialsByEmailQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetPersonCredentialsByEmailQuery({
 *   variables: {
 *      email: // value for 'email'
 *   },
 * });
 */
export function useGetPersonCredentialsByEmailQuery(baseOptions: Apollo.QueryHookOptions<GetPersonCredentialsByEmailQuery, GetPersonCredentialsByEmailQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetPersonCredentialsByEmailQuery, GetPersonCredentialsByEmailQueryVariables>(GetPersonCredentialsByEmailDocument, options);
      }
export function useGetPersonCredentialsByEmailLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetPersonCredentialsByEmailQuery, GetPersonCredentialsByEmailQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetPersonCredentialsByEmailQuery, GetPersonCredentialsByEmailQueryVariables>(GetPersonCredentialsByEmailDocument, options);
        }
...
export const GetPersonOrdersByEmailDocument = gql`
    query GetPersonOrdersByEmail($email: String!) {
  person(where: {email: $email}) {
    orders
  }
}
...
/**
 * __useGetPersonOrdersByEmailQuery__
 *
 * To run a query within a React component, call `useGetPersonOrdersByEmailQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetPersonOrdersByEmailQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetPersonOrdersByEmailQuery({
 *   variables: {
 *      email: // value for 'email'
 *   },
 * });
 */
export function useGetPersonOrdersByEmailQuery(baseOptions: Apollo.QueryHookOptions<GetPersonOrdersByEmailQuery, GetPersonOrdersByEmailQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetPersonOrdersByEmailQuery, GetPersonOrdersByEmailQueryVariables>(GetPersonOrdersByEmailDocument, options);
      }
export function useGetPersonOrdersByEmailLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetPersonOrdersByEmailQuery, GetPersonOrdersByEmailQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetPersonOrdersByEmailQuery, GetPersonOrdersByEmailQueryVariables>(GetPersonOrdersByEmailDocument, options);
        }
 ...
 *
 * To run a query within a React component, call `useGetProductListByPageQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetProductListByPageQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetProductListByPageQuery({
 *   variables: {
 *      skipCount: // value for 'skipCount'
 *   },
 * });
 */
export function useGetProductListByPageQuery(baseOptions?: Apollo.QueryHookOptions<GetProductListByPageQuery, GetProductListByPageQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetProductListByPageQuery, GetProductListByPageQueryVariables>(GetProductListByPageDocument, options);
      }
export function useGetProductListByPageLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetProductListByPageQuery, GetProductListByPageQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetProductListByPageQuery, GetProductListByPageQueryVariables>(GetProductListByPageDocument, options);
        }
export type GetProductListByPageQueryHookResult = ReturnType<typeof useGetProductListByPageQuery>;
export type GetProductListByPageLazyQueryHookResult = ReturnType<typeof useGetProductListByPageLazyQuery>;
export type GetProductListByPageQueryResult = Apollo.QueryResult<GetProductListByPageQuery, GetProductListByPageQueryVariables>;
...
export const PublishReviewByIdDocument = gql`
  ...
  publishReview(where: $reviewId, to: [PUBLISHED]) {
    ...
    ${ReviewContentFragmentDoc}`;
export type PublishReviewByIdMutationFn = Apollo.MutationFunction<PublishReviewByIdMutation, PublishReviewByIdMutationVariables>;

/**
 * __usePublishReviewByIdMutation__
 *
 * To run a mutation, you first call `usePublishReviewByIdMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `usePublishReviewByIdMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [publishReviewByIdMutation, { data, loading, error }] = usePublishReviewByIdMutation({
 *   variables: {
 *      reviewId: // value for 'reviewId'
 *   },
 * });
 */
export function usePublishReviewByIdMutation(baseOptions?: Apollo.MutationHookOptions<PublishReviewByIdMutation, PublishReviewByIdMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<PublishReviewByIdMutation, PublishReviewByIdMutationVariables>(PublishReviewByIdDocument, options);
      }
...
export const UpdatePersonOrdersByEmailDocument = gql`
    mutation UpdatePersonOrdersByEmail($email: String!, $orders: [String!]) {
  updatePerson(where: {email: $email}, data: {orders: $orders}) {
    id
  }
}
    `;
export type UpdatePersonOrdersByEmailMutationFn = Apollo.MutationFunction<UpdatePersonOrdersByEmailMutation, UpdatePersonOrdersByEmailMutationVariables>;

/**
 * __useUpdatePersonOrdersByEmailMutation__
 *
 * To run a mutation, you first call `useUpdatePersonOrdersByEmailMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdatePersonOrdersByEmailMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updatePersonOrdersByEmailMutation, { data, loading, error }] = useUpdatePersonOrdersByEmailMutation({
 *   variables: {
 *      email: // value for 'email'
 ...
 * });
 */
export function useUpdatePersonOrdersByEmailMutation(baseOptions?: Apollo.MutationHookOptions<UpdatePersonOrdersByEmailMutation, UpdatePersonOrdersByEmailMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdatePersonOrdersByEmailMutation, UpdatePersonOrdersByEmailMutationVariables>(UpdatePersonOrdersByEmailDocument, options);
      }
export type UpdatePersonOrdersByEmailMutationHookResult = ReturnType<typeof useUpdatePersonOrdersByEmailMutation>;
export type UpdatePersonOrdersByEmailMutationResult = Apollo.MutationResult<UpdatePersonOrdersByEmailMutation>;
export type UpdatePersonOrdersByEmailMutationOptions = Apollo.BaseMutationOptions<UpdatePersonOrdersByEmailMutation, UpdatePersonOrdersByEmailMutationVariables>;
export const UpsertOrderDocument = gql`
